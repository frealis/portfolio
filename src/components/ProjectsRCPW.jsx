      ...
      <div className="row projects-row">
        ...
        <div className="col-lg-7 projects-col">
          <div className="projects-col-top">
            ...
            <p className="projects-thumbnail-description">This is a business website for a pressure washing company hosted on Amazon Web Services that uses AWS Simple Email Service (SES) to handle contact form requests for customer contact and follow-up, as well as Amazon RDS and PostgreSQL to store contact form submissions. It also uses the Google Maps Javascript API to display a custom map, as well as reCAPTCHA v3 to monitor contact form submissions.</p>
          </div>
